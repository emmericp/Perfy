...
assert(cpuStacks["Fun1"] == 2000000)
assert(cpuStacks["Fun1;Fun2"] == 3000000)
assert(cpuStacks["Fun1;Fun2;Fun3"] == 1000000)
assert(cpuStacks["Fun1;Fun2;Fun4"] == 1000000)
assert(cpuStacks["Fun4"] == 1000000)

local memStacks = analyze:FlameGraph(trace, "memory", "memoryOverhead")
assert(memStacks["Fun1;Fun2;Fun3"] == 10)
assert(memStacks["Fun1;Fun2;Fun4"] == 20)
assert(memStacks["Fun4"] == 20)
